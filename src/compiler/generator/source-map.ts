...
export default class SourceMap {
    _cachedMap: sourceMap.SourceMapGenerator
    _code: any
    _opts: { sourceRoot: any; sourceFileName: string; }
    _rawMappings: any[] | {
            // undefined to allow for more compact json serialization
            name: string; generated: { line: number; column: number; }; source: any; original: { line: number; column: number; };
        }[]
    _lastGenLine: number;
    _lastSourceLine: number;
    _lastSourceColumn: number;

  constructor(opts: any, code: any) {
